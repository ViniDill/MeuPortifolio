...
function generateMedia() {
  ...
  var lessThan = function lessThan2(breakpoint) {
    return function() {
      return at(_templateObject(), getSizeFromBreakpoint(breakpoint, breakpoints), at.apply(void 0, arguments));
    };
  };
  var greaterThan = function greaterThan2(breakpoint) {
    return function() {
      return at(_templateObject2(), getSizeFromBreakpoint(breakpoint, breakpoints), at.apply(void 0, arguments));
    };
  };
  var between = function between2(firstBreakpoint, secondBreakpoint) {
    return function() {
      return at(_templateObject3(), getSizeFromBreakpoint(firstBreakpoint, breakpoints), getSizeFromBreakpoint(secondBreakpoint, breakpoints), at.apply(void 0, arguments));
    };
  };
  var oldStyle = Object.keys(breakpoints).reduce(function(acc, label) {
    ...
    acc.to[label] = function() {
      ...
      return at(_templateObject4(), size, at.apply(void 0, arguments));
    };
    acc.from[label] = function() {
      ...
      return at(_templateObject5(), size, at.apply(void 0, arguments));
    };
    return acc;
  }, {
    to: {},
